...
docker run --name='grafana' --network='app-video-max' -d -p 3000:3000 --link loki grafana/grafana
sleep 5
curl -fsSL https://raw.githubusercontent.com/ivancarlosantos/installer/refs/heads/master/progress_bar_spinner.sh | bash
...
docker run --name='rabbitmq' --network='app-video-max' --hostname='rabbit-host' -d -p 5672:5672 -p 15672:15672 rabbitmq:4.0-management-alpine
sleep 5
curl -fsSL https://raw.githubusercontent.com/ivancarlosantos/installer/refs/heads/master/progress_bar_spinner.sh | bash
...
echo "PGAdmin SGBD"
docker run --name pgadmin --network app-video-max -d -p 15432:80 -e PGADMIN_DEFAULT_EMAIL='admin' -e PGADMIN_DEFAULT_PASSWORD='icarlos@icarlos' dpage/pgadmin4:latest
sleep 5
curl -fsSL https://raw.githubusercontent.com/ivancarlosantos/installer/refs/heads/master/progress_bar_spinner.sh | bash
