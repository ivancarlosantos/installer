...
sleep 3
docker run --name=jecuz-test --network=jecuz_app -d -p 8080:8080 -e DB_USERNAME='postgres' -e DB_PASSWORD='12345' -e DB_URL='jdbc:postgresql://postgres:5432/jecuz?loggerLevel=OFF' devmenorzera/jecuz:release
sleep 5
